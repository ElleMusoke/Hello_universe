...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%% Figure 15: B=0.75 intersection curve calculation %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%% Figure 16: Intersection curve comparisons %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\put(0,3){
	\begin{picture}(180,100)(0,0)
	    \put(0,0){\includegraphics[width=12.6cm]{./figures_raw/error_compare.png}}
	    \put(79.75,45){$q$}
	    \put(105.5,28){$C^3$}
	    \put(92.2,40.25){$C^2$}
	    \put(99.5,37.5){$F_2$}
...
%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% Figure 16: MMO surface interaction %%%
%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Figure 18: Compare MMOs and singular objects%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\put(-5.6,87){
	\begin{picture}(85,43)(5,7)
	\put(10.25,10){\includegraphics[width=5.6cm]{./figures_raw/MMO_series_1.png}}
	\put(11,50.5){(a)}
	\end{picture}
	\caption{}
	}
...
\put(51.9,87){
	\begin{picture}(85,43)(5,7)
	\put(10.25,10){\includegraphics[width=5.6cm]{./figures_raw/MMO_series_2.png}}
	\end{picture}
	\caption{}
	}
...
\put(109,87){
	\begin{picture}(85,43)(5,7)
	\put(10.25,10){\includegraphics[width=5.6cm]{./figures_raw/MMO_series_3.png}}
	\put(11,50.5){(b)}
	\end{picture}
	\caption{}
	}	
...
\put(-5.6,41.5){
	\begin{picture}(85,43)(5,7)
	\put(10.25,10){\includegraphics[width=5.6cm]{./figures_raw/MMO_series_4.png}}
	\end{picture}
	\caption{}
	}
...
\put(51.9,41.5){
	\begin{picture}(85,43)(5,7)
	\put(10.25,10){\includegraphics[width=5.6cm]{./figures_raw/MMO_series_5.png}}
	\end{picture}
	\caption{}
	}
...
\put(109,41.5){
	\begin{picture}(85,43)(5,7)
	\put(10.25,10){\includegraphics[width=5.6cm]{./figures_raw/MMO_series_6.png}}
	\end{picture}
	\caption{}
	}	
...
\put(-5.5,-4){
	\begin{picture}(85,43)(5,7)
	\put(10.25,10){\includegraphics[width=5.6cm]{./figures_raw/MMO_series_7.png}}
	\end{picture}
	\caption{}
	}
...
\put(51.9,-4){
	\begin{picture}(85,43)(5,7)
	\put(10.25,10){\includegraphics[width=5.6cm]{./figures_raw/MMO_series_8.png}}
		\put(11,50.5){(c)}
	\end{picture}
	\caption{}
	}
...
\put(109,-4){
	\begin{picture}(85,43)(5,7)
	\put(10.25,10){\includegraphics[width=5.6cm]{./figures_raw/MMO_series_9.png}}
	\end{picture}
	\caption{}
	}
...
\put(-5.5,-49.5){
	\begin{picture}(85,43)(5,7)
	\put(10.25,10){\includegraphics[width=5.6cm]{./figures_raw/MMO_series_10.png}}
	\end{picture}
	\caption{}
	}
...
\put(51.9,-49.5){
	\begin{picture}(85,43)(5,7)
	\put(10.25,10){\includegraphics[width=5.6cm]{./figures_raw/MMO_series_11.png}}
	\end{picture}
	\caption{}
	}
...
\put(109,-49.5){
	\begin{picture}(85,43)(5,7)
	\put(10.25,10){\includegraphics[width=5.6cm]{./figures_raw/MMO_series_12.png}}
	\put(11,50.5){(a)}
	\end{picture}
	\caption{}
	}				
