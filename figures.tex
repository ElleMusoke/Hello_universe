...
% This will output a pdf with a page for each figure, nicely cropped according to picture dimenstions as defined below in the `Figure' Section. Inlcude in the final document by using package 'graphicx' and command \includegraphics[page=<page of figure>]{figures.pdf}
...
\begin{figure}
	...
	\put(10.25,10){\includegraphics[width=8cm]{./figures/paper_critical.eps}}
	\put(81,44){$F_1$}
        \put(19,29){$F_2$}
        \put(72.5,13.5){$H$}
        \put(80,13){$C^4_-$}
...
\begin{figure}
	\begin{picture}(117,64.5)(93,96.5)
	    \put(100,100){\includegraphics[width=11cm]{./figures/paper_slow.eps}}
	    \put(196.5,153.5){$F_1$}
...
\put(0,45){
	...
	\put(10.25,10){\includegraphics[width=8cm]{./figures/step1.eps}}
...
\put(88,45){
	\begin{picture}(85,43)(5,7)
	\put(10.25,10){\includegraphics[width=8cm]{./figures/step2.eps}}
        \put(72,37){$E^s(p_{\mathrm{out}})$}
...
\put(0,0){
	\begin{picture}(85,43)(5,7)
	\put(10.25,10){\includegraphics[width=8cm]{./figures/step3.eps}}
 	\put(72,36.5){$\Omega$}
        \put(19,40){$\psi$}
	\put(81,44){$F_1$}
        \put(19,29){$F_2$}
...
\put(89,0){\begin{picture}(85,43)(5,7)
	\put(10.25,10){\includegraphics[width=8cm]{./figures/step4.eps}}
	\put(72,36.5){$\Omega$}
        \put(33,20){$\psi$}
	\put(81,44){$F_1$}
        \put(19,29){$F_2$}
...
\put(50,140){
	\begin{picture}(180,100)(0,0)
	    \put(0,0){\includegraphics[width=12.6cm]{./figures/one_piece_paper_BAX.png}}
...
\put(50,58){
	\begin{picture}(180,100)(0,0)
	    \put(0,0){\includegraphics[width=12.6cm]{./figures/one_piece_paper_BAY.png}}
...
\put(50,140){
	\begin{picture}(180,100)(0,0)
	    \put(0,0){\includegraphics[width=12.6cm]{./figures/two_pieces_paper_BAX.eps}}
...
\put(50,60){
	\begin{picture}(180,100)(0,0)
	    \put(0,2){\includegraphics[width=12.6cm]{./figures/two_pieces_paper_BAY.eps}}
...
\put(50,140){
	\begin{picture}(180,100)(0,0)
	    \put(0,0){\includegraphics[width=12.6cm]{./figures/five_pieces_paper_BAX.eps}}
...
\put(50,35){
	\begin{picture}(180,100)(0,0)
	    \put(0,0){\includegraphics[width=12.6cm]{./figures/five_pieces_paper_BAY.eps}}
...
\put(100,160){
	\begin{picture}(180,100)(0,0)
	    \put(0,24){\includegraphics[width=12.6cm]{./figures/unstable_piece_BAX.eps}}
...
\put(100,85){
	\begin{picture}(180,100)(0,0)
	    \put(3,19.5){\includegraphics[width=12.6cm]{./figures/unstable_piece_BAY.eps}}
...
\put(0,45){
	\begin{picture}(85,43)(5,7)
	\put(10.25,10){\includegraphics[width=8cm]{./figures/Lin1.eps}}
        \put(50,38){$S^3$}
        \put(50,17){$S^2$}
        \put(7,46){$A$}
        \put(6,38.5){\footnotesize $9.0$}
...
\put(88,42){
	\begin{picture}(85,43)(5,7)
	\put(10.25,10){\includegraphics[width=8cm]{./figures/Lin2.eps}}
...
\put(0,0){
	\begin{picture}(85,43)(5,7)
	\put(10.25,10){\includegraphics[width=8cm]{./figures/Lin3.eps}}
        \put(7,46){$A$}
...
\put(89,0){\begin{picture}(85,43)(5,7)
	\put(10.25,10){\includegraphics[width=8cm]{./figures/Lin4.eps}}
...
\put(50,140){
	\begin{picture}(180,100)(0,0)
	    \put(0,0){\includegraphics[width=12.6cm]{./figures/hetclin_6_BAX.eps}}
...
\put(50,50){
	\begin{picture}(180,100)(0,0)
	    \put(0,-0.5){\includegraphics[width=12.6cm]{./figures/hetclin_6_BAY.eps}}
...
\put(50,162){
	\begin{picture}(180,100)(0,0)
	    \put(0,0){\includegraphics[width=12.6cm]{./figures/paper_saddle_unstable_BAX.eps}}
	    \put(91,72){$W^u(q)$}
	    \put(105.5,28){$C^3$}
	    \put(108,4.5){$C^{4}_{+}$}
	    \put(91,-1){$F_1$}
...
\put(50,71.5){
	\begin{picture}(180,100)(0,0)
	    \put(0,0){\includegraphics[width=12.6cm]{./figures/paper_saddle_unstable_BAY.eps}}
	    \put(87,51){$W^u(q)$}
	    \put(105.5,13){$C^3$}
	    \put(108,4.5){$C^{4}_{+}$}
	    \put(2.5,41.5){$C^{4}_{-}$}
...
\put(50,140){
	\begin{picture}(180,100)(0,0)
	    \put(0,0){\includegraphics[width=12.6cm]{./figures/paper_BAX.eps}}
	    \put(90,41){$C^2$}
	     \put(81.5,45){$q$}
	    \put(105.5,28){$C^3$}
	    \put(99.5,37.5){$F_2$}
...
\put(50,55){
	\begin{picture}(180,100)(0,0)
	    \put(0,0){\includegraphics[width=12.6cm]{./figures/paper_singular_BAX.eps}}
 \put(90,41){$C^2$}
	     \put(81.5,45){$q$}
	    \put(105.5,28){$C^3$}
	    \put(99.5,37.5){$F_2$}
...
\begin{figure}
	\begin{picture}(124,64.5)(86.5,96.5)
	    \put(100,100){\includegraphics[width=11cm]{./figures/paper_isola.eps}}
	    \put(87,157){max($A$)}
...
\put(50,140){
	\begin{picture}(180,100)(0,0)
	    \put(0,0){\includegraphics[width=12.6cm]{./figures/MMO_surface_interaction_BAX.eps}}
	    \put(114,13.25){$C^2$}
	    \put(107,4){$C^3$}
	    \put(108,81){(b)}
	    \put(95,37){$\mathscr{H}$}
...
\put(50,163){
	\begin{picture}(180,100)(0,0)
	    \put(0,0){\includegraphics[width=12.6cm]{./figures/MMO_2_BAX.eps}}
	    \put(70,-2){$C^{4}_{+}$}
	     \put(26,16){$C^{4}_{-}$}
...
\put(120,199){
	\begin{picture}(180,100)(0,0)
	    \put(0,0){\includegraphics[width=12.6cm]{./figures/MMO_1_BAX.eps}}
	    \put(70,-2){$C^{4}_{+}$}
	     \put(26,16){$C^{4}_{-}$}
	     \put(90,18){$\mathscr{H}_0$}
	     \put(64,50){$\mathscr{P}$}
...
\put(120,85){
	\begin{picture}(180,100)(0,0)
	    \put(0,0){\includegraphics[width=12.6cm]{./figures/MMO_3_BAX.eps}}
	    \put(70,-2){$C^{4}_{+}$}
	     \put(26,16){$C^{4}_{-}$}
	     \put(90,18){$\mathscr{H}_0$}
	     \put(64,50){$\mathscr{P}$}
